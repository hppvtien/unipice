...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> PreviewCode.Net</h1>
      <p class="text-muted"><a href="/"><i>Về trang chủ</i></a></p>

      <div class="custom-control custom-switch" style="padding-bottom:20px;">
        <input type="checkbox" class="custom-control-input" checked id="darkSwitch">
