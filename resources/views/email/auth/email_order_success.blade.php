            ...
            <tr>
               <td align="center" valign="top">
                                                                        ...
                                                                        <tr>
                                                                           <td style="
                                                                              ...
                                                                              <span style="
                                                                                 font-size: 22px;
                                                                                 ">
                                                                              <b>Xin chào khách hàng ...Tên Khách Hàng (công ty nếu có),</b>
                                                                              </span>
                                                                              </span>
                                                                           </td>
                                                                        </tr>
                  ...
                  <td style="
                     ...
                     ">
                  <div>
                  <p style="font-size: 16px;margin-bottom: 10px!important;">Cám ơn Quý khách đã thanh toán  hóa đơn số#…..theo số hóa đơn  được tạo vào ngày (ngày tạo hóa đơn).
</p>
                  </div>
                  <div style="text-align: justify;">
                  <p style="font-size: 16px;margin-bottom: 10px!important;">
                  Hình thức thanh toán của quý khách :  </p>
                  </div>
                  <div style="text-align: justify;">
                  <p style="font-size: 16px;margin-bottom: 10px!important;">Ngày thanh toán: </p>
                  </div>
                  <div style="text-align: justify;">
                  <p style="font-size: 16px;margin-bottom: 10px!important;">Xem chi tiết hóa đơn: <a  style="color: #0b2d25;" href="#">Tại đây</a></p>
                  </div>
                   <div style="text-align: justify;">
                                                                                            ...
                                                                                            <tbody><tr>
                                                                                                <td width="auto" valign="middle" bgcolor="#ea7236" align="center" height="40" style="font-size:18px; font-family:Arial,Helvetica,sans-serif; color:#ffffff; font-weight:normal; padding-left:20px; padding-right:20px; vertical-align: middle; background-color:#ea7236;border-radius:4px;border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;">
                                                                                                    <span style="color:#ffffff; font-weight:normal;">
                                                                                                            <a style="text-decoration:none; color:#ffffff; font-weight:normal;" target="_blank" href="{{ route('verify.email', $data['code_verication']) }}">Đăng ký Spice Club</a>
                                                                                                        </span>
                                                                                                </td>
                                                                                            </tr></tbody></table>
