...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <body>
        <table border="0" align="center" cellpadding="0" cellspacing="0" class="main-template" bgcolor="#f9fafc" style="background-color: rgb(249, 250, 252)">
            <tbody>
                <tr>
                                                                ...
                                                                <tr>
                                                                    <td valign="top" height="38">
                                                                        <img width="20" height="38" style="
                                                                            ...
                                                                            max-height: 38px;
                                                                            max-width: 20px;
                                                                            " alt="" src="https://app.sendinblue.com/rnb-editor/assets/new_images/rnb_space.gif" />
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="rnb-del-min-width" align="center" valign="top" style="min-width: 590px">
                                                            ...
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rnb-container" bgcolor="#0b2d25" style="
                                                                background-color: rgb(11, 45, 37);
                                                                border-radius: 0px;
                                                                padding-left: 20px;
                                                                padding-right: 20px;
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td valign="middle" align="center" style="line-height: 1px">
                                                                                                            <div style="
                                                                                                                ...
                                                                                                                <div>
                                                                                                                    <img width="300" vspace="0" hspace="0" border="0" alt="admall" style="
                                                                                                                        float: left;
                                                                                                                        max-width: 300px;
                                                                                                                        display: block;
                                                                                                                        " class="rnb-logo-img" src="https://img.mailinblue.com/3994151/images/rnb/original/61246ae5d964a1288e5d3b09.png" />
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </td>
                                                                                                    </tr>
                ...
                <tr>
                    <td align="center" valign="top">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="
                                                                                                        ...
                                                                                                        <span style="
                                                                                                            font-size: 22px;
                                                                                                            ">
                                                                                                        <b>Chào mừng Quý khách {{ $userss['name'] }} đã đăng ký tài khoản thành viên “ Spice Club” !</b>
                                                                                                        </span>
                                                                                                        </span>
                                                                                                    </td>
                                                                                                </tr>
                        ...
                        <td style="
                            ...
                            ">
                        <div>
                        <p style="font-size: 16px;margin-bottom: 10px!important;">Hệ thống đã tiếp nhận yêu cầu đăng ký tài khoản từ Quý khách.</p>
                        </div>
                        <div style="text-align: justify;">
                        <p style="font-size: 16px;margin-bottom: 10px!important;">
                        Quý khách vui lòng nạp tiền để hệ thống kích hoạt tài khoản thành viên “Spice Club” cho quý khách với hướng dẫn dưới đây. </p>
                        </div>
                        </td>
                        </tr>
                        </tbody>
                        ...
                        <tr>
                        <td height="10">
                        <table style="border: 1px solid #111;margin-top: 10px;">
                        <tr style="font-weight: 600;">
                        <td colspan="2" style="padding:5px">Hưỡng dẫn thanh toán phí đăng ký thành viên “spice club” :</td>
                        </tr>
                        <tr style="border: 1px solid #111;margin-left: 5px;">
                        <td align="left" style="padding-left: 5px;border-right: 1px solid;">Email đăng ký</td>
                        ...
                        <td align="left" style="padding-left: 5px;border-right: 1px solid;"><a href="{{ route('get.register.spiceclub') }}">Đăng nhập</a></td>
                        </tr>
                        </table>
                        </td>
                        </tr>
                        ...
                        <table width="100%" cellpadding="0" border="0" align="center" cellspacing="0" bgcolor="#ffffff" style="
                            padding-right: 20px;
                            padding-left: 20px;
                            background-color: rgb(255, 255, 255);
                            ">
