         ...
         <tbody>
            ...
            <tr>
               <td align="center" valign="top">
                  ...
                  <p style="font-size: 16px;margin-bottom: 10px!important; text-align: justify;">Chúng tôi đã hủy đơn hàng số: {{ $uni_order['code_invoice'] }} theo yêu cầu của quý khách.  Bất cứ lúc nào quý khách hàng cũng có thể đặt mua những sản phẩm của chúng tôi tại UniMall, và chúng tôi luôn sẵn sàng phục vụ tới quý khách.</p>
                  </div>
