            ...
            <td align="center" valign="top">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="600" id="m_5063188309675374655template_container" style="background-color:#ffffff;border:1px solid #dedede;border-radius:3px">
                    <tbody>
                        <tr>
                            <td align="center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="m_5063188309675374655template_header" style="background-color:#122a67;color:#ffffff;border-bottom:0;font-weight:bold;line-height:100%;vertical-align:middle;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;border-radius:3px 3px 0 0">
                                    <tbody>
                                        <tr>
                                                            ...
                                                            <td valign="top" style="padding:48px 48px 32px">
                                                                <div id="m_5063188309675374655body_content_inner" style="color:#636363;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left">
                                                                    ...
                                                                    <p style="margin:0 0 16px">Cảm ơn đã đặt hàng. Đơn
                                                                        ...
                                                                        hàng:</p>
                                                                    <section>
                                                                        <h2 style="color:#122a67;display:block;font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif;font-size:18px;font-weight:bold;line-height:130%;margin:0 0 18px;text-align:left">
                                                                            Invoice</h2>
                                                                        <ul>
                                                                            <li>Mã đơn hàng:
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top" width="50%" style="text-align:left;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif;border:0;padding:0">
                                                                                    ...
                                                                                    <address style="padding:12px;color:#636363;border:1px solid #e5e5e5">
                                                                                        ...
                                                                                        <br><a href="tel:{{ $configuration->hotline }}" style="color:#122a67;font-weight:normal;text-decoration:underline" target="_blank">{{ $configuration->hotline }}</a>
                                                                                        <br><a href="mailto:{{ $configuration->email }}" target="_blank">{{ $configuration->email }}</a>
                                                                                    </address>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
