                        ...
                        <div class="col-md-12 ">
                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    ...
                                    @else
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Đăng Nhập Spice Club</a>
                                    @endif 
                                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Đăng Ký Spice Club</a>
                                </div>
                            </nav>
                            @if (get_data_user('web'))
                            @else
                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                                ...
                                                <fieldset class="fieldsets create account" data-hasrequired="* Required Fields">
                                                    ...
                                                    <div class="m-checkbox field choice become_associate_member">
                                                        <input type="checkbox" name="type"
                                                            title="Become An Associate Member" value="2" id="associate_member_request"
                                                            class="m-checkbox__input checkbox">
                                                        <label for="associate_member_request" class="label">
                                                            <div class="m-checkbox__square"></div>
                                                            <span class="m-checkbox__text-label">Đăng ký làm thành viên Spice Club</span>
                                                        </label>
                                                    </div>
                                                </fieldset>
                                                <div class="actions-toolbar">
                                                    <div class="primary">
                                                        <button type="submit" class="a-btn a-btn--primary submit" title="Create an Account">
                                ...
                                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                    <div class="form-create-account-box">
                                        <h2 class="c-login__block-heading" id="block-customer-login-heading">Đăng ký Spice Club</h2>
                                        <form class="form create account form-create-account" action="{{ route('post.register.spiceclub') }}" method="POST" id="formRegister">
                                            @csrf
                                            <fieldset class="fieldsets create info">
                                                <span class="text-strong gd-danger">Nếu bạn có tài khoản, Hãy đăng nhập để đăng ký tài khoản Spice Club.</span>
                                                <div class="field field-name-firstname required">
                                                    <div class="m-text-input m-text-input--placeholder-label control">
