    ...
    <div class="rev-slider-full">
        <div id="rev_slider_14_1_wrapper" class="rev_slider_wrapper fullscreen-container bg-primary" data-alias="gravitydesign1" data-source="gallery" style="padding:0px;">
            <div id="rev_slider_2_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
                <ul>
                    <li data-index="rs-7" data-responsive="on" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300" data-thumb="{{ asset('/images/icon_menu/anh_nen_b2b.jpg') }}" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-liquideffect='{"image":"{{ asset('/images/icon_menu/anh_nen_b2b.jpg') }}","imagesize":"external","autoplay":true,"scalex":4,"scaley":4,"speedx":0.5,"speedy":-0.5,"rotationx":0,"rotationy":0,"rotation":0,"transtime":2000,"easing":"Power3.easeOut","transcross":false,"transpower":false,"transitionx":0,"transitiony":0,"transpeedx":0,"transpeedy":0,"transrotx":0,"transroty":0,"transrot":0}'>
                        <video controls autoplay loop>
                            <source src="{{ asset('/images/icon_menu/video_about.mp4') }}" type="video/mp4">
                        </video>
                        <h1 class="tp-caption font-primary" id="slide-7-layer-13-1" data-x="['left','left','middle','middle']" data-hoffset="['0','30','0','0']" data-y="['middle','middle','top','top']" data-voffset="['-200','-200','80','20']" data-fontsize="['54','54','54','40']" data-width="auto" data-height="auto" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-responsive="on" data-frames='[{"delay":1200,"split":"words","splitdelay":0.05,"speed":1000,"split_direction":"forward","frame":"0","from":"x:50px;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","split":"words","splitdelay":0.02,"speed":300,"split_direction":"backward","frame":"999","to":"auto:auto;fb:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" style="z-index: 7; white-space: nowrap; font-size: 54px; line-height: 54px; letter-spacing: 0px; color:#fff">{{ $content_page_1->name}}</h1>
                        <p class="tp-caption Restaurant-Description " id="slide-7-layer-13-2" data-x="['left','left','middle','middle']" data-hoffset="['0','30','0','0']" data-y="['middle','middle','top','top']" data-voffset="['-100','-100','180','80']" data-fontsize="['18','18','18','18']" data-fontsize="['50','50','50','50']" data-lineheight="['30','30','30','30']" data-fontweight="['700','700','700','700']" data-width="['480','400','480','400']" data-height="auto" data-visibility="['on', 'on', 'off', 'off']" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1500,"split":"words","splitdelay":0.05,"speed":1000,"split_direction":"forward","frame":"0","from":"x:50px;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","split":"words","splitdelay":0.02,"speed":300,"split_direction":"backward","frame":"999","to":"auto:auto;fb:0;","ease":"Power3.easeInOut"}]' data-textAlign="['left','left','center','center']" style="z-index: 5; min-width: 480px; max-width: 480px; white-space: normal; letter-spacing: 0px; color:#fff">{{ $content_page_1->desscription}}</p>
                        <a class="tp-caption rev-btn button button-large m-0 button-white fw-bold button-circle button-light" href="{{ $content_page_1->url_but}}" target="_blank" id="slide-7-layer-13" data-x="['left','left','middle','middle']" data-hoffset="['0','30','0','0']" data-y="['middle','middle','bottom','bottom']" data-voffset="['200','200','30','0']" data-textAlign="['center','center','center','center']" data-width="200" data-height="auto" data-type="button" data-actions='' data-responsive_offset="off" data-responsive="off" data-fontsize="['17', '17', '15', '15']" data-lineheight="['40', '40', '30', '30']" data-frames='[{"delay":3000,"speed":1600,"frame":"0","from":"x:50px;z:0;rX:0;rY:0;rZ:0;sX:1.1;sY:1.1;skX:0;skY:0;opacity:0;fbr:100;","bgcolor":"#FFF","to":"o:1;fbr:100;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","bgcolor":"#FFF","to":"opacity:0;fbr:100;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"150","ease":"Power1.easeInOut","to":"o:1;rX:0;rY:0;rZ:0;z:0;fbr:90%;","style":"c:#fff;"}]' style="z-index: 9; background-color: #0b2d25; padding: 4px 28px; color:#fff; text-align: center;"><span>{{ $content_page_1->name_but}}</span> <i class="icon-angle-right"></i>
                        </a>
                    </li>
                </ul>
    ...
    <div class="section-full bg-white pizza-full-menu">
            ...
            <div class="container">
                <ul class="nav nav-tabs pizza-items" id="myTab" role="tablist">
                    ...
                    <li class="nav-item item">
                        <a class="item-icon-box nav-link {{ $i==0 ? 'active' : '' }} render-slug" data-slug="{{ getSlugCategory($item->slug) }}" id="pizza-tab{{ $item->id }}" data-toggle="tab" href="#pizza{{ $item->id }}" role="tab" aria-controls="pizza{{ $item->id }}" aria-selected="true">
        ...
        <div class="content-inner can_trai_phai">
                    ...
                    <div class="dz-col col m-b30 pt-5 pb-5 ">
                        <div class="item-box shop-item style2">
                            ...
                            <div class="item-info text-center">
                                ...
                                <a href="{{ getSlugProduct($value1->slug) }}" title="{{ $value1->name }}">
                                    <p class="price text-primary">{{ $value1->name }}</p>
                                </a>
                                <div class="cart-btn"><a href="{{ getSlugProduct($value1->slug) }}" class="btn btnhover radius-xl"><i class="ti-shopping-cart"></i> Xem chi tiết</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
            ...
            <div class="content-inner can_trai_phai text-center">
                <a href="{{ getSlugCategory($menu1[0]->slug) }}" class="btn btn-info text-center show-more-about">Xem thêm</a>
            </div>
        </div>
    ...
    <div class="section-full bg-white">
        ...
        <div class="row manu-box-reverse sp0">
            <div class="col-lg-6 p-lg-5 pading_about">
                <div class="menu-box">
                    <div class="section-head style-2">
                        <h2 class="title">Giới thiệu chi tiết</h2>
                    </div>
                    <p></p>
                    <p>UNISPICE là một trong những thương hiệu của Công ty TNHH UNIKERY, chuyên nghiên cứu &amp;</p>

                    <p>Với sứ mệnh kế thừa và phát triển tinh hoa ẩm thực Việt đồng thời nghiên cứu tinh túy ẩm thực thế giới,&nbsp;thị trường những sản phẩm hương vị truyền thống, mà còn thỏa mãn nhu cầu xu hướng ẩm thực toàn cầu phong phú cùng khẩu vị ngày càng cao của khách hàng. Các sản phẩm gia vị tự nhiên, gia vị hoàn chỉnh, bột nêm, gia vị &amp; xốt ướp nướng BBQ được làm từ nguyên liệu chất lượng được lựa chọn nghiêm ngặt từ khâu đầu vào đến chế biến, hoàn thiện đóng gói.</p>
                    <p></p>
                </div>
            </div>
            <div class="col-lg-6 p-lg-5 pading_about">
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                        ...
                        <div class="c-login__block block-customer-login">
                            ...
                            <div class="block-content" aria-labelledby="block-customer-login-heading">
                                <form class="form form-login" action="https://unimall.vn/dang-nhap" method="POST" id="formLogin">
                                    <input type="hidden" name="_token" value="fTcGYi2JdJKNqOUjpbodmZ8Z2q9CLKJuIePUCsf6"> <input name="form_key" type="hidden" value="1">
                                    <fieldset class="fieldsets login" data-hasrequired="* Required Fields">
                                        ...
                                        <div class="field email required">
                                            ...
                                            <div class="m-text-input m-text-input--placeholder-label control">
                                                <input name="email" id="email" type="email" class="a-text-input m-text-input__input input-text js-placeholder-label-not-empty" title="Email">
                                                <label class="a-form-label m-text-input__label label" for="email"><span>Email</span></label>
                                            </div>
                                        </div>
                                        <div class="field password required">
                                            <div class="m-text-input m-text-input--placeholder-label control">
                                                <input name="password" type="password" class="a-text-input m-text-input__input input-text js-placeholder-label-not-empty" id="pass" title="Password">
                    ...
                    <div class="tab-pane fade active show" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="form-create-account-box">
                            <form class="form create account form-create-account" action="https://unimall.vn/b2b" method="POST" id="formRegister">
                                <input type="hidden" name="_token" value="fTcGYi2JdJKNqOUjpbodmZ8Z2q9CLKJuIePUCsf6">
                                ...
                                <fieldset class="fieldsets create account" data-hasrequired="* Required Fields">
                                    <div class="field required">
                                        <div class="m-text-input m-text-input--placeholder-label control">
                                            <input type="email" name="email" id="email_address" value="" title="Email" class="a-text-input m-text-input__input input-text js-placeholder-label-not-empty">
                                            <label for="email_address" class="a-form-label m-text-input__label label"><span>Email</span></label>
                                        </div>
                                    </div>
                                    <div class="field password required">
                                        <div class="m-text-input m-text-input--placeholder-label control">
                                            <input type="password" name="password" id="password" title="Password" class="a-text-input m-text-input__input input-text js-placeholder-label-not-empty">
