    ...
    <div class="right-content">
        ...
        <form action="{{ route('get.login') }}" method="POST" id="formLogin">
            ...
            <div class="remember-login flex flex-jc-sb">
                ...
                <a href="{{ route('get.forgetpassword') }}" class="forgot-psswrd" data-target="#k-popup-account-reset" data-toggle="modal" data-ajax="" data-push-state="false">Quên mật khẩu?</a>
            </div>
            <div id="js-error" >                 
            </div>
