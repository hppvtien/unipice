                            ...
                            <table class="data table totals">
                                <tbody>
                                    ...
                                    <tr class="totals sub">
                                        ...
                                        <td class="amount">
                                            <span class="price" data-th="Subtotal">$6.65</span>
                                        </td>
                                    </tr>
                                    <tr class="grand totals">
                                        ...
                                        <td class="amount" data-th="Order Total">
                                            <strong><span class="price">$6.65</span></strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                        ...
                                        <a href="https://www.coopmarket.com/self-closing-lid-for-1-2-gallon-plastic-container" title="Self Closing Lid for 1/2 Gallon Plastic Container" tabindex="-1" class="product-item-photo">
                                            <span class="product-image-container" style="width:110px;">
                                                <span class="product-image-wrapper" style="padding-bottom: 145.45454545455%;">
                                                    <img class="product-image-photo" src="https://acquia.prod.wholesale.frontiercoop.com/sites/default/files/acquiadam/2020-09/1_Frontier-Co-op-Self-Closing-Lid-Half-Gallon-12401-Front.jpg" max-width="100%" max-height="100%" alt="Self Closing Lid for 1/2 Gallon Plastic Container">
                                                </span>
                                            </span>
                                        </a>
