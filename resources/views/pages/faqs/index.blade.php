                                        ...
                                        <div data-block-plugin-id="entity_view:taxonomy_term">
                                            <div class="c-page-header c-page-header--light">
                                                <picture class="c-page-header__image">
                                                    <source media="(min-width: 1024px)" data-srcset="{{ pare_url_file($page_faq->p_banner) }}">
                                                    <img class="lazyload" data-src="{{ pare_url_file($page_faq->p_banner) }}" alt="{{ $page_faq->p_name }}">
                                                </picture>
                                                <div class="c-page-header__content">
                                                    <h1 class="c-page-header__headline">
                                                        <div class="field field--name-name field--type-string field--label-hidden field__item">{{ $page_faq->p_name }}</div>
                                                    </h1>
                                                </div>
                                            </div>
