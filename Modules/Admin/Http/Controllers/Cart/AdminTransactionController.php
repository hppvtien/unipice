...
class AdminTransactionController extends AdminController
{
    ...
    {
        $transactions = Transaction::with('user:id,name,email')->where('t_status','!=',4)->orderByDesc('id')
            ->paginate(20);
    ...
    public function trash()
    {
        ...
        return view('admin::pages.transaction.trash', $viewData);
    }
    public function movetrash($id)
    {
        $transaction = Transaction::findOrFail($id);
        $transaction->t_status = 4;
        $transaction->save();
