        ...
        <div class="col-lg-8">
            <div class="card  box-shadow-0">
                <div class="card-body pt-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control keypress-count" data-title-seo=".meta_title" value="{{ old('name', $postcategory->name ?? '') }}" data-slug=".slug" name="name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control slug" name="slug" value="{{ old('slug', $postcategory->slug ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control keypress-count" data-desscription-seo=".meta_desscription" name="desscription" value="{{ old('desscription', $postcategory->desscription ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control content" name="content" value="{{ old('content', $postcategory->content ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="SumoSelect js-sumo-select sumo_somename" tabindex="0" role="button" aria-expanded="true">
                            <select name="parent_id" class="form-control SlectBox SumoUnder" tabindex="-1">
                                ...
                                <option value="{{ $item->id }}" {{ ($postcategory->parent_id ?? 0) == $item->id ? "selected" : "" }}>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <div class="card  box-shadow-0">
                ...
                <div class="form-group">
                        ...
                        <input type="text" class="form-control meta_title" name="meta_title" value="{{ old('meta_title', $postcategory->meta_title ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control meta_desscription" name="meta_desscription" value="{{ old('meta_desscription', $postcategory->meta_desscription ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control meta_keyword" name="meta_keyword" value="{{ old('meta_keyword', $postcategory->meta_keyword ?? '') }}">
