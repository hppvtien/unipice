        ...
        <div class="breadcrumb-header justify-content-between">
            ...
            <div class="d-flex my-xl-auto right-content">
                <div class="pr-1 mb-3 mb-xl-0">
                    <a href="{{ route('get_admin.course_question.create', $id) }}" class="btn btn-info  mr-2">Thêm mới <i class="la la-plus-circle"></i></a>
                    ...
                    <div class=" tab-menu-heading">
                        <div class="tabs-menu1">
                            ...
                            <ul class="nav panel-tabs main-nav-line">
                                ...
                                <li><a href="{{ route('get_admin.course_question.index', $id) }}"  class="nav-link active">Câu hỏi và trả lời</a></li>
                                        ...
                                        @foreach($questions as $item)
                                            <div class="item">
                                                            ...
                                                            @foreach($item->answers as $key => $answer)
                                                                <li style="list-style: none">
                                                                    <p style="display: flex;justify-content: space-between">
                                                                        ...
                                                                        <a style="text-align: right"  href="{{ route('get_admin.course_question.success',
                                                ...
                                                <div class="item-action">
                                                    <a href="{{ route('get_admin.course_question.edit', ['id' => $id,'questId' => $item->id]) }}" class="btn btn-xs"><i class="la la-edit"></i></a>
                                                    <a href="{{ route('get_admin.course_question.delete', ['id' => $id,'questId' => $item->id]) }}" class="btn btn-xs js-delete"><i class="la la-trash"></i></a>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
