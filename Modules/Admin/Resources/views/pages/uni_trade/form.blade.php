            ...
            <div class="card  box-shadow-0">
                <div class="card-body pt-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control slug" name="slug" value="{{ old('slug', $trade->slug ?? '') }}">
            ...
            <div class="card  box-shadow-0">
                <div class="card-header">
                    ...
                    <div class="view-seo">
                        ...
                        {{ old('meta_title', $trade->meta_title ?? 'It is Very Easy to Customize and it uses in your website apllication.') }}
                        </a>
                        <p class="view-seo-slug slug">
                        {{ old('slug', $trade->slug ?? 'It is Very Easy to Customize and it uses in your website apllication.') }}
                        </p>
                        <p class="mb-2 view-seo-description meta_desscription">
                        {{ old('meta_desscription', $trade->meta_desscription ?? 'It is Very Easy to Customize and it uses in your website apllication.') }}
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control meta_keyword" name="meta_keyword" value="{{ old('meta_keyword', $trade->meta_keyword ?? '') }}">
