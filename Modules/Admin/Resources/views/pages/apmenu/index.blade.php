                    ...
                    <div class="row">
                        <div class="col-sm-5 col-xs-12">
                            <div class="box box-default">
                                <div class="box-body">
                                    ...
                                    <button class="btn btn-primary btnShowMenu">Hiển thị <i class="fa fa-spinner fa-spin" style="display: none"></i> </button>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-7 col-xs-12">
                            <menu id="nestable-menu" class="text-center">
                                <button class="btn btn-primary btnSaveMenu" type="button">Lưu Menu</button>
                                <button class="btn btn-info" type="button" data-action="expand-all">Mở rộng tất cả</button>
                                <button class="btn btn-danger" type="button" data-action="collapse-all">Thu gọn tất cả</button>
                            </menu>
