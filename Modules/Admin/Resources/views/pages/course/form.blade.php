                            ...
                            <div class="panel-body tabs-menu-body main-content-body-right border-top-0 border">
                                <div class="tab-content">
                                                ...
                                                <div class="SumoSelect js-sumo-select sumo_somename" tabindex="0" role="button" aria-expanded="true">
                                                    <select name="c_category_id" class="form-control SlectBox SumoUnder"  tabindex="-1">
                                                        @foreach($categories as $category)
                                                            <option title="{{ $category->c_name }}" {{ ($course->c_category_id ?? 0) == $category->id ? "selected" : "" }} value="{{ $category->id }}">{{ $category->c_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="SumoSelect js-sumo-select sumo_somename" tabindex="0" role="button" aria-expanded="true">
                                                        <select name="c_teacher_id" class="form-control SlectBox SumoUnder" tabindex="-1">
                                                            @foreach($teachers as $teacher)
                                                                <option title="{{ $teacher->t_name }}" {{ ($course->c_teacher_id ?? 0) == $teacher->id ? "selected" : "" }} value="{{ $teacher->id }}">{{ $teacher->t_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        ...
                                        <textarea name="c_about" class="form-control" id="article-ckeditor" cols="30" rows="10">{!! old('c_about',$course->c_about ?? '') !!}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card  box-shadow-0 ">
                <div class="card-body pt-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="d_avatar" value="{{ old('c_avatar', $slide->c_avatar ?? '') }}">
