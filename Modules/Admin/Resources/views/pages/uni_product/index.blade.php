...
<div class="container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="input-group md-form form-sm form-2 pl-0 w-50">
            <input class="form-control my-0 py-1 amber-border" id="search_k" type="text" data-url="{{ route('get_admin.uni_product.search_ajax') }}" placeholder="Tìm kiếm theo tên" aria-label="Search">
        ...
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <a href="{{ route('get_admin.uni_product.create') }}" class="btn btn-info  mr-2">Thêm mới <i class="la la-plus-circle"></i></a>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
