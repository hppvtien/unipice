                    ...
                    <div class="form-group">
                        ...
                        <div class="SumoSelect js-sumo-select sumo_somename" tabindex="0" role="button" aria-expanded="true">
                            <select name="c_status" class="form-control SlectBox SumoUnder"  tabindex="-1">
                                <option title="hide" value="0" {{ ($category->status ?? 0) == 0 ? 'selected' : '' }}>No Active</option>
                                <option title="Public" value="1" {{ ($category->status ?? 0) == 1 ? 'selected' : '' }}>Active</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="card  box-shadow-0 ">
                <div class="card-body pt-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="d_avatar" value="{{ old('c_avatar', $category->c_avatar ?? '') }}">
