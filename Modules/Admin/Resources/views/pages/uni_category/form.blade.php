            ...
            <div class="card  box-shadow-0">
                <div class="card-body pt-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control keypress-count" data-title-seo=".meta_title" value="{{ old('name', $uni_cate->name ?? '') }}" data-slug=".slug" name="name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control slug" name="slug" value="{{ old('slug', $uni_cate->slug ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control keypress-count" data-desscription-seo=".meta_desscription" name="desscription" value="{{ old('desscription', $uni_cate->desscription ?? '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="SumoSelect js-sumo-select sumo_somename" tabindex="0" role="button" aria-expanded="true">
                            <select name="parent_id" class="form-control SlectBox SumoUnder" tabindex="-1">
                                ...
                                <option value="{{ $item->id }}" {{ ($uni_cate->parent_id ?? 0) == $item->id ? "selected" : "" }}>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
