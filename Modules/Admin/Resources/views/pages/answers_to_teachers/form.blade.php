                ...
                <div class="card-body pt-3">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="">Trạng thái </label>
                                <select name="asw_status" id="asw_status">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="">Hình ảnh </label>
                                <img style="height: 100%;border-radius: 10px;border: 1px solid #dedede;width: 100%" src="/storage/uploads_Video/{{ $answerToTeacher->asw_image }}" alt="">
                            </div>
                        </div>
                    </div>
