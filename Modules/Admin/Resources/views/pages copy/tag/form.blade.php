            ...
            <div class="card  box-shadow-0">
                <div class="card-header">
                    ...
                    <div class="view-seo">
                        ...
                        <p class="view-seo-slug">It is Very Easy to Customize and it uses in your website apllication. <span class="slug">view-seo-slug</span></p>
            ...
            <div class="card  box-shadow-0 ">
                <div class="card-body pt-3">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="d_avatar" value="{{ old('t_avatar', $tag->t_avatar ?? '') }}">
