...
Route::middleware('checkLoginUser')->group(function() {
    ...
    Route::get('updateCart.html', 'UserCartController@updateCart')->name('get_user.updatecart');
    Route::get('xoa-san-pham', 'UserCartController@deletecart')->name('get_user.deletecart');
    Route::get('deleteAllCart', 'UserCartController@deleteAllCart')->name('get_user.deleteAllCart');
