    ...
    <div class=" columns">
        <div class="column main padding_css row no-gutters">
            ...
            <div class="block block-dashboard-info col-md-12 col-xs-12 noi_left text-center">
                <p class="text-success text-center" style="margin:0 auto 10px auto">Vui Lòng thanh toán đơn hàng <span
                        class="text-danger" id="invoice-id">{{ $order->code_invoice }}</span> của bạn. <br>
                    Đơn hàng <span class="text-danger">{{ $order->code_invoice }}</span> của bạn chỉ có giá trị khi
                    bạn đã thanh toán</p>
                <button class="a-btn a-btn--primary text-center action apply primary w-25" id="default-success"
                    data-url="{{ route('post_user.paysuccsess', $order->id) }}" type="button" value="Pay Continue">
