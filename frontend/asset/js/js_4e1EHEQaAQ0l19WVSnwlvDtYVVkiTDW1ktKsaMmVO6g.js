...
(function($) {
    ...
    function addSigninLink() {
        $('.m-account-menu').prepend(`<li class="m-account-menu__item">
    ...
    <span class="m-account-menu__link-text">
      ${ messaging.account.login.text }
        ...
        if ($('.c-header__account-button.js-account a').length) { $('.c-header__account-button.js-account a').attr('href', `${ storeEndpoint+messaging.account.login.url }`); }
    }
