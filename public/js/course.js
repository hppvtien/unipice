...
var Cart = {
  ...
  processCartPay: function processCartPay() {
    ...
    $(".js-save-cart").click(function (event) {
      event.preventDefault();
      var $this = $(this);
      var group_buy = $("input[name='group_buy']:checked").val();
      ...
      var method_course = $("input[name='method_course']").val();
      var method_phone = $("input[name='method_phone']").val();
      var total_paid = $("#total_paid").text();
      var total_no_vat = $("#total_no_vat").text();
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\unimind\resources\assets\js\pages\course\course.js */"./resources/assets/js/pages/course/course.js");
